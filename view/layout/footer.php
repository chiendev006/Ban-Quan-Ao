        ...
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold">
                    <span class="text-primary font-weight-bold border border-white px-3 mr-1">E</span>ElectroShop
                </h1>
            </a>
            <p>Cửa hàng chuyên cung cấp các thiết bị điện tử như điều hòa, máy giặt, tủ lạnh với chất lượng cao và giá cả hợp lý. Sự hài lòng của bạn là ưu tiên của chúng tôi.</p>
            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Đường ABC, Hà Nội, Việt Nam</p>
            <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>lienhe@electroshop.vn</p>
        ...
        <div class="col-lg-8 col-md-12">
            <div class="row">
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-dark mb-2" href="about.html"><i class="fa fa-angle-right mr-2"></i>Giới Thiệu</a>
                        <a class="text-dark mb-2" href="policy.html"><i class="fa fa-angle-right mr-2"></i>Chính Sách Bảo Hành</a>
                        <a class="text-dark mb-2" href="delivery.html"><i class="fa fa-angle-right mr-2"></i>Chính Sách Giao Hàng</a>
                        <a class="text-dark" href="support.html"><i class="fa fa-angle-right mr-2"></i>Hỗ Trợ Khách Hàng</a>
                    </div>
                </div>
                <div class="col-md-4 mb-5">
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-dark">
                &copy; <a class="text-dark font-weight-semi-bold" href="#">ElectroShop</a>. Tất cả các quyền được bảo lưu. Thiết kế bởi
